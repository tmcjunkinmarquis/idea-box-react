...
class AddIdeaCard extends React.Component {
  ...
  render() {
    return (
      <section>
        <NameInput cardNameStateChange={this.cardNameStateChange}/> 
        <BodyInput cardBodyStateChange={this.cardBodyStateChange}/>
        <SaveButton cardToLocalStorage={this.cardToLocalStorage} />
      </section> 
    );
  }
}
